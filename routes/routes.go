...
func Router() *mux.Router {
	...
	router.HandleFunc("/api/getSingleUser/{id}", controllers.GetSingleUserDocument).Methods("GET")
	router.HandleFunc("/api/deleteAllUsers", controllers.DeleteAllUser).Methods("DELETE")
	return router
}
